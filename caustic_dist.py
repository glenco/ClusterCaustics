...
df_los = pd.read_csv("DataFiles/snap_058_centered.txt.cy2049x2049S30Zl0.529400LOSg.csv")

df_los = df_los[ df_los['caustic_area'] > 0]
df_los = df_los[ df_los['critical_area'] > 0]


df = pd.read_csv("DataFiles/snap_058_centered.txt.cy2049x2049S30Zl0.529400.csv")
...
#plt.fill_between(xx,y,label="total")
plt.plot(xx,y,label="total")
